        ...
        <div className="flex gap-8">
            ...
            {sidebarItems.map((item) => (
              <button
                ...
                className={`w-full px-4 py-3 rounded-lg text-left font-medium transition-all mb-1 ${
                  activeTab === item.id
                    ? 'bg-cyan-500/20 border-l-4 border-cyan-500 text-cyan-500'
          ...
          <div className="flex-1 bg-slate-800/50 border border-slate-700/30 rounded-xl p-8">
            ...
            {activeTab === 'organization' && (
              <div>
                <h2 className="text-2xl font-bold text-cyan-500 mb-6">Organization Settings</h2>
                ...
                <div className="space-y-6">
                  ...
                  <div className="pb-6 border-b border-slate-700/30">
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 bg-slate-900/60 border border-slate-700/50 rounded-lg text-slate-100 placeholder-slate-500 focus:outline-none focus:border-cyan-500"
                    />
                  </div>
                  ...
                  <div className="pb-6 border-b border-slate-700/30">
                    ...
                    <div className="flex gap-3">
                      <input
                        ...
                        placeholder="#06b6d4"
                        maxLength={7}
                        className="flex-1 px-4 py-3 bg-slate-900/60 border border-slate-700/50 rounded-lg text-slate-100 placeholder-slate-500 focus:outline-none focus:border-cyan-500"
                      />
                      <input
                        type="color"
                  ...
                  <div className="pb-6 border-b border-slate-700/30">
                    ...
                    <select className="w-full px-4 py-3 bg-slate-900/60 border border-slate-700/50 rounded-lg text-slate-100 focus:outline-none focus:border-cyan-500">
                ...
                <button
                  ...
                  className="mt-8 px-6 py-3 bg-gradient-to-r from-cyan-500 to-cyan-600 text-white rounded-lg font-semibold shadow-lg shadow-cyan-500/30 hover:shadow-cyan-500/40 hover:-translate-y-0.5 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  💾 Save Changes
                </button>
              </div>
            ...
            {activeTab === 'profile' && (
              <div>
                <h2 className="text-2xl font-bold text-cyan-500 mb-6">Profile Settings</h2>
            ...
            {activeTab === 'notifications' && (
              <div>
                <h2 className="text-2xl font-bold text-cyan-500 mb-6">Notification Settings</h2>
                <div className="text-slate-400 text-center py-12">
                  <div className="text-6xl mb-4">🔔</div>
            ...
            {activeTab === 'email' && (
              <div>
                <h2 className="text-2xl font-bold text-cyan-500 mb-6">Email Settings</h2>
                ...
                <div className="space-y-6">
                  ...
                  <div className="pb-6 border-b border-slate-700/30">
                    ...
                    <select
                      ...
                      className="w-full px-4 py-3 bg-slate-900/60 border border-slate-700/50 rounded-lg text-slate-100 focus:outline-none focus:border-cyan-500"
                    >
            ...
            {activeTab === 'billing' && (
              <div>
                <h2 className="text-2xl font-bold text-cyan-500 mb-6">Billing Settings</h2>
            ...
            {activeTab === 'security' && (
              <div>
                <h2 className="text-2xl font-bold text-cyan-500 mb-6">Security Settings</h2>
                <div className="text-slate-400 text-center py-12">
                  <div className="text-6xl mb-4">🔐</div>
            ...
            {activeTab === 'integrations' && (
              <div>
                <h2 className="text-2xl font-bold text-cyan-500 mb-6">Integrations</h2>
                    ...
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <button
                        ...
                        className={`w-14 h-7 rounded-full transition-all relative ${
                          googleDriveEnabled ? 'bg-cyan-500' : 'bg-slate-700'
                        }`}
                      >
                        <div
